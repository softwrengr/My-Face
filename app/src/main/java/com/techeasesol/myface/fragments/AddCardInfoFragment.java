...
public class AddCardInfoFragment extends Fragment {
    ...
    private void apiCallUpdateCardInfo() {
        ...
        final Call<AddCardResponseModel> resgistration = services.addCardInfo(cardID, nameBody, numberlBody, emailBody, postBody, addresstBody, fbBody, twitterBody, instagramBody, linkedinBody, skypeBody, youtubeBody, profileImage, Bodyname);
