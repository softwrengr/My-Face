...
public class UpdateCardInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_update_card_info, container, false);
        getActivity().setTitle("Update Card Info");
        BaseNetworking.grantPermission(getActivity());
        token = GeneralUtils.getApiToken(getActivity());
        ID = GeneralUtils.getCardIDForUpdate(getActivity());
    ...
    private void apiCallUpdateCardInfo() {
        ...
        final Call<AddCardResponseModel> resgistration = services.updateCardInfo(ID, nameBody, numberlBody, emailBody, postBody, addresstBody, fbBody, twitterBody, instagramBody, linkedinBody, skypeBody, youtubeBody, profileImage, Bodyname);
        resgistration.enqueue(new Callback<AddCardResponseModel>() {
            ...
            public void onResponse(Call<AddCardResponseModel> call, Response<AddCardResponseModel> response) {
                ...
                if (response.body() == null) {
                    ...
                    if(GeneralUtils.checkFragment(getContext()))
                    GeneralUtils.connectDrawerFragment(getActivity(), new YourCardFragment());
                    else {
                        GeneralUtils.connectDrawerFragment(getActivity(), new AllSavedCardsFragment());
                    }
                }
    ...
    private boolean validate() {
        ...
        if (sourceFile == null) {
            Toast.makeText(getActivity(), "please select your picture also", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
