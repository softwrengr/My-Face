package com.techeasesol.myface.models.cardStatusDataModels;
...
public class CardStatusDataModel {
    ...
    @Expose
    private CardStatusUpdateModel statusUpdatedAt;
    ...
    public CardStatusUpdateModel getStatusUpdatedAt() {
        return statusUpdatedAt;
    }

    public void setStatusUpdatedAt(CardStatusUpdateModel statusUpdatedAt) {
