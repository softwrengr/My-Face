...
public class GeneralUtils {
    ...
    public static int getCardID(Context context) {
        return getSharedPreferences(context).getInt("main_card_id", 0);
    }
    ...
    public static int getCardIDForUpdate(Context context) {
        return getSharedPreferences(context).getInt("update_card_id", 0);
    }
    ...
    public static boolean checkFragment(Context context) {
        return getSharedPreferences(context).getBoolean("check_fragment", false);
    }
